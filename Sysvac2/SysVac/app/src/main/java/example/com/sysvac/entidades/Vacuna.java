...
public class Vacuna {
    ...
    public Vacuna(int id_vacuna, String nombre, int dosis, int edad, String fecha, String lote, String nombre_medico, String descripcion, int id_hijo, int aplicada, int mes_aplicacion) {
    ...
    public Vacuna(Cursor cursor) {
        ...
        mes_aplicacion= cursor.getInt(cursor.getColumnIndex(VacunaEntry.MES_APLICADA));
    }
    ...
    public ContentValues toContentValues() {
        ...
        values.put(VacunaEntry.MES_APLICADA,mes_aplicacion);
        return values;
    }
