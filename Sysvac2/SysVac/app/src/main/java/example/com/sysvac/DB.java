...
public class DB extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "DBHijos";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        /*db.execSQL("CREATE TABLE IF NOT EXISTS Usuarios (id_usuario INTEGER PRIMARY KEY," +
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS Vacunas ( id_vacuna integer not null , nombre text not null, " +
                    ...
                    "aplicada INTEGER,mes_aplicacion INTEGER," +
    ...
    public void insertarDatos( SQLiteDatabase sqLiteDatabase) {
        ...
        insertarVacunas(sqLiteDatabase, new Vacuna(6, "OPV/IPV",2 , 0, "08/07/2016",
                "BXAS22", "Marcos", "segunda dosis", 1,1,4));
        ...
        insertarVacunas(sqLiteDatabase, new Vacuna(10, "OPV/IPV",3 , 0, "08/09/2016",
                "BXAS22", "Marcos", "tercera dosis",1,1,6));
        ...
        insertarVacunas(sqLiteDatabase, new Vacuna(18," V.V.Z",1 , 1, "08/06/2017",
                null, null, "al año y 3 meses", 1,0,15));
        ...
        insertarVacunas(sqLiteDatabase, new Vacuna(18," V.V.Z",1 , 1, "08/06/2018",
                null, null, "al año y 3 meses", 2,0,15));
    ...
    public Cursor getHijoById(String hijoId) {
        SQLiteDatabase xr = this.getWritableDatabase();
        String q = "SELECT * FROM "+ HijosEntry.TABLE_NAME +" where id_hijo=? ";
        Cursor registros = xr.rawQuery(q,new String[]{hijoId});
        return registros;
    }

    public ArrayList jeje(int id_hijo){
        ArrayList<Integer> lista = new ArrayList<>();
        String si="0";
        SQLiteDatabase database = this.getWritableDatabase();
        String q = "SELECT * FROM "+ VacunaEntry.TABLE_NAME +" where id_hijo=? and "+VacunaEntry.APLICADA+" =?";
        Cursor registros = database.rawQuery(q,new String[]{Integer.toString(id_hijo),si});
        if(registros.moveToFirst()){
            do{
                lista.add(registros.getInt(10));
